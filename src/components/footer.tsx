...
const Footer = () => {
  ...
  <div className="w-[341px] h-[21px] text-sm text-gray-600">
    <span>@ 2021 - Blogy - Designed & Developed by Zakirsoft</span>
  </div>

  {/* Right div */}
  <div className=" w-[227px] h-[27px] top-[24px] left-[1393px] flex justify-between items-center">
    <a href="#" className="text-gray-600 hover:text-teal-600">PayPal</a>
    <a href="#" className="text-gray-600 hover:text-teal-600">American Express</a>
    <a href="#" className="text-gray-600 hover:text-teal-600">Visa</a>
  </div>
</div>
